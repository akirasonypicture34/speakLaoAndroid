...
public class SearchActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((RelativeLayout) findViewById(R.id.list_rl)).setOnClickListener(this);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				try {
					...
					mp = MediaPlayer.create(SearchActivity.this, songId);
	...
	private void getData(String search_char) {
		// String resp = "";
		englishWordList.removeAll(englishWordList);
		thaiWordList.removeAll(thaiWordList);
		proWordList.removeAll(proWordList);
		soundList.removeAll(soundList);

		String searchChar = search_char.trim();
		DBAdapter db = new DBAdapter(context);
		db.open();
		Cursor cs;
		if (searchChar.equals(null) || searchChar.equalsIgnoreCase("")) {

			cs = null;
		} else {
			cs = db.getSearchData(searchChar);
		}
		if (cs != null) {
	...
	public void onClick(View v) {
		...
		int id = v.getId();
		if (id == R.id.home_btn) {
			Intent ih = new Intent(SearchActivity.this, HomeActivity.class);
			startActivity(ih);
		} else if (id == R.id.setting_btn) {
			Intent is = new Intent(SearchActivity.this, SettingActivity.class);
			startActivity(is);
		} else if (id == R.id.list_rl) {
			InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
